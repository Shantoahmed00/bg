...
def mr_error():
    ...
    if innocent == '':
        ...
        try:
            ...
            print(" %s[%s#%s] ____________________________________________________________________________________"%(N,O,N));time.sleep(2)
            ...
            print(" %s[%s#%s] ____________________________________________________________________________________"%(N,O,N))
